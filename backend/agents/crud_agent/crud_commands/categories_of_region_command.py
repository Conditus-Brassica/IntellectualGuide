...
class CategoriesOfRegionCommand(BaseCommand):
    """
    Command to get landmarks categories of region from PureCRUDAgent children classes.
    """
    ...
    async def execute(self):
        """
        Execute command to get landmarks categories of region from PureCRUDAgent children classes.
        ...
        """
        return await self._target_agent.get_categories_of_region(self._json_params)
