...
class LandmarksOfCategoriesInRegionCommand(BaseCommand):
    """
    Command to get landmarks that refer to any of the given categories and located in given region from PureCRUDAgent
    children classes.
    """
    ...
    async def execute(self):
        """
        Execute command to get landmarks that refer to any of the given categories and located in given region from
        PureCRUDAgent children classes.
        ...
        """
        return await self._target_agent.get_landmarks_of_categories_in_region(self._json_params)
